...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference('Sample.count') do
      post samples_url, params: { sample: { address: @sample.address, age: @sample.age, name: @sample.name } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { address: @sample.address, age: @sample.age, name: @sample.name } }
